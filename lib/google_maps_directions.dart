class GoogleDirectionModel {
  List<GeocodedWaypoints> geocodedWaypoints;
  List<Routes> routes;
  String status;

  GoogleDirectionModel({this.geocodedWaypoints, this.routes, this.status});

  GoogleDirectionModel.fromJson(Map<String, dynamic> json) {
...
class Routes {
  ...
  Routes.fromJson(Map<String, dynamic> json) {
    ...
    overviewPolyline = json['overview_polyline'] != null?
         new PolylineM.fromJson(json['overview_polyline'])
        : null;
...
class Steps {
  ...
  Steps.fromJson(Map<String, dynamic> json) {
    ...
    polyline = json['polyline'] != null?
         new PolylineM.fromJson(json['polyline'])
        : null;
    startLocation = json['start_location'] != null?
         new Northeast.fromJson(json['start_location'])
        : null;
...
class PolylineM {
  ...
  PolylineM({this.points});

  PolylineM.fromJson(Map<String, dynamic> json) {
    points = json['points'];
  }
